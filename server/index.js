...
import { getRangeInfo, getDivisorInfo, test2 } from './api'
...
app.get('/api/rangeInfo', async (req, res) => {
  const data = await getRangeInfo()
  console.log(data)
  res.json(data)
})

app.get('/api/divisorInfo', async (req, res) => {
  const data = await getDivisorInfo()
  console.log(data)
  res.json(data)
})
